...
//
// This is a modified version of telegram's oembed javascript file
// The modification allows for the same telegram post to occur more than once on the DOM
//
...
export default (function (window) {
    ...
    (function (window) {
        ...
        function initWidget(widgetEl) {
            ...
            if (!widgetEl.tagName ||
                !(widgetEl.tagName.toUpperCase() == 'SPAN' ||
            ...
            if (widgetId = widgetEl.getAttribute('data-telegram-post')) {
                ...
                src = `https://t.me` + '/' + widgetId + '?embed=1';
        ...
        if (!document.currentScript ||
            ...
            if (document.querySelectorAll) {
                widgets = document.querySelectorAll('span[data-telegram-post],blockquote.telegram-post,script[data-telegram-login]');
            } else {
                widgets = Array.prototype.slice.apply(document.getElementsByTagName('SPAN'));
