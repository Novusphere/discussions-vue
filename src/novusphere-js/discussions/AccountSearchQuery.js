...
export class AccountSearchQuery {
    ...
    async nextRaw() {
        ...
        try {
            ...
            const { id, count, limit, accounts } = await apiRequest(`/v1/api/search/accounts`, queryObject);
            ...
            if (deltaTime > 1000)
                console.proxyLog(`AccountSearchQuery took ${deltaTime}ms to return results`, this.pipeline);
